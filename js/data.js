...
const LEVELS = [
  ...
  {id:2, name:'La Rivière Périlleuse',  sky:'#080d18', bgFar:'#0f1a30', bgNear:'#162240', ground:'#1e3a6e', plat:'#4a3a80', funnySky:'#b0e0ff', funnyBgFar:'#4169e1', funnyBgNear:'#1e90ff', funnyGround:'#00ced1', funnyPlat:'#9932cc', groups:['groupe1'],         tenses:['pr','im'], tenseLabel:'Présent & Imparfait',      numEnemies:5, enemyType:'skeleton', emoji:'💧'},
