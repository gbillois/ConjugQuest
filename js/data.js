...
const LEVELS = [
  {id:1, name:'La Forêt Magique',       biome:'forest',      sky:'#0d1a0d', bgFar:'#14381a', bgNear:'#1a5020', ground:'#2d6b22', plat:'#7c5a20', funnySky:'#87ceeb', funnyBgFar:'#90ee90', funnyBgNear:'#228b22', funnyGround:'#32cd32', funnyPlat:'#d2691e', groups:['groupe1'],         tenses:['pr'],      tenseLabel:'Présent',                  numEnemies:4, enemyType:'forest-sprite',   emoji:'🌲'},
  {id:2, name:'Le Désert des Pharaons', biome:'desert',      sky:'#e8a830', bgFar:'#c07820', bgNear:'#a05810', ground:'#c8a040', plat:'#b08828', funnySky:'#ffe4a0', funnyBgFar:'#f5c842', funnyBgNear:'#e8a020', funnyGround:'#ffd060', funnyPlat:'#e09020', groups:['groupe1'],         tenses:['pr','im'], tenseLabel:'Présent & Imparfait',      numEnemies:5, enemyType:'desert-scorpion', emoji:'🦂'},
  {id:3, name:'Les Montagnes Gelées',   biome:'snow',        sky:'#0a1020', bgFar:'#102040', bgNear:'#1a3060', ground:'#2a4a7a', plat:'#4a6a9a', funnySky:'#e8f4fc', funnyBgFar:'#b0d0f0', funnyBgNear:'#90b8e8', funnyGround:'#c8e0f8', funnyPlat:'#8ab0d0', groups:['groupe1','groupe2'],tenses:['pr'],      tenseLabel:'Présent (G1 + G2)',         numEnemies:6, enemyType:'snow-yeti',       emoji:'❄️'},
  {id:4, name:'Les Cavernes de Pierre', biome:'mountain',    sky:'#080810', bgFar:'#101020', bgNear:'#181830', ground:'#303050', plat:'#505070', funnySky:'#fff9c4', funnyBgFar:'#ffd700', funnyBgNear:'#ffa500', funnyGround:'#ff8c00', funnyPlat:'#dc143c', groups:['groupe2'],         tenses:['pr','im'], tenseLabel:'Présent & Imparfait (G2)', numEnemies:6, enemyType:'mountain-troll',  emoji:'⛏️'},
  {id:5, name:'La Désolation Finale',   biome:'desolation',  sky:'#080808', bgFar:'#101010', bgNear:'#181818', ground:'#202020', plat:'#303030', funnySky:'#fce4ec', funnyBgFar:'#ff8a65', funnyBgNear:'#ff5722', funnyGround:'#f44336', funnyPlat:'#e91e63', groups:['groupe3'],         tenses:['pr','fu'], tenseLabel:'Présent & Futur simple',  numEnemies:7, enemyType:'desolation-wraith', emoji:'👻'},
];
